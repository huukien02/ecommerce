      ...
      <main className="mx-auto min-h-screen max-w-5xl px-4 py-8 md:px-8">
        {isAdmin ? (
          <div className="rounded-lg border p-10 text-center">
            <h1 className="mb-2 text-2xl font-semibold">Admin cannot place orders</h1>
            <p className="mb-4 text-muted-foreground">Use the admin area to manage products, categories, orders, and users.</p>
            <Button asChild>
        ...
        <div className="mb-6 flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">Kiem tra san pham truoc khi checkout.</p>
          </div>
          <Button asChild variant="outline">
            <Link href="/products">Mua tiep</Link>
          </Button>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
            ...
            <aside className="h-fit rounded-lg border p-5">
              <h2 className="mb-4 text-lg font-semibold">Tong don</h2>
